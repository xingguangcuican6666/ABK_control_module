...
export ABK_BUILD_WORK_MODE="lkm"
...
export ABK_MANAGER_PACKAGE="com.example.abk"
export ABK_MANAGER_CERT_SIZE="1234"
export ABK_MANAGER_CERT_SHA256="0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"
...
grep -qF '.work_mode = "lkm"' "$KERNEL_ROOT/common/drivers/abk_control/abk_control_manifest.c"
...
grep -qF '"companion_download_url"' "$KERNEL_ROOT/common/drivers/abk_control/core.c"
grep -qF '"service_activity"' "$KERNEL_ROOT/common/drivers/abk_control/core.c"
...
grep -qF 'ABK_JSON_FIELD("module_dir", module_dir);' "$KERNEL_ROOT/common/drivers/abk_control/core.c"
grep -qF 'ABK_JSON_FIELD("web_root", web_root);' "$KERNEL_ROOT/common/drivers/abk_control/core.c"
grep -qF '"has_web_ui"' "$KERNEL_ROOT/common/drivers/abk_control/core.c"
grep -qF '"has_action_script"' "$KERNEL_ROOT/common/drivers/abk_control/core.c"
grep -qF '"action_supported"' "$KERNEL_ROOT/common/drivers/abk_control/core.c"
grep -qF 'ABK_CONTROL_OPS_HAS_RUNTIME_UI' "$KERNEL_ROOT/common/include/linux/abk_control.h"
